...
import { deleteItem, searchByPage, getById } from "./SpecimenService";
...
class SpecimentFilter extends Component {
    constructor(props) {
        super(props);
        this.state = {
            niheCodeTo: "",
...
export default SpecimentFilter;