...
import EIDEditorDialog from "./EIDEditorDialog";
import { Breadcrumb, ConfirmationDialog } from "egret";
import { useTranslation, withTranslation, Trans } from "react-i18next";
import SearchIcon from "@material-ui/icons/Search";
import { saveAs } from "file-saver";
import UploadEIDExcel from "../../uploadExcel/UploadEIDExcel";
import UploadFormPopupProperties from "../../uploadExcel/UploadFormPopupProperties";
    ...
    return (
      <div className="m-sm-30">
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("EID.title") }]} />
        </div>
              ...
              {this.state.shouldOpenUploadExcelResultDialog && (
                <UploadFormPopupProperties
                  ...
                  uploadUrl={
                    ...
                    "/api/uploadExcel/lab-test-result/true"
                  }
                />
              )}
            </div>
...
export default connect(mapStateToProps, mapDispatch)(EID);
