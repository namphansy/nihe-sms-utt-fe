...
import { checkCode, addNewReagent, updateReagent } from "./InternalTestService";
...
class InternalTestInformation extends Component {
  state = {
    name: "",
    code: "",
    description: "",
...
export default InternalTestInformation;
