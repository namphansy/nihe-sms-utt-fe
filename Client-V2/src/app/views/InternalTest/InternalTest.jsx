...
import {
  ...
  searchInternalTest,
  getItemById,
} from "./InternalTestService";
import ReagentCodeEditorDialog from "./InternalTestEditorDialog";
...
class InternalTest extends Component {
  ...
  render() {
    ...
    let columns = [
      ...
      {
        title: t("internalTest.expirationDate"),
      ...
      {
        title: t("internalTest.productionFacilityName"),
        field: "productionFacilityName",
        align: "center",
        width: "150",
        headerStyle: {
          paddingLeft: "10px",
    ...
    return (
      <div className="m-sm-30">
        <Helmet>
          <title>
            {t("internalTest.title")} | {t("web_site")}
          </title>
        </Helmet>
...
export default connect(mapStateToProps, mapDispatch)(InternalTest);
