import {
  ...
  import ReagentCodeFilePopup from "./InternalTestFilePopup";
  ...
  class InternalTestFileAttachment extends React.Component {
    constructor(props) {
      super(props);
    }
    state = {
  ...
  export default InternalTestFileAttachment;
