...
import PatientResultHivFilter from "./ResultByDayFillter";
...
class Result extends Component {
  ...
  handleFilter = (option, actions) => {
    this.props.getLoading(true);
    const { t } = this.props;
    const { resultDateSearch, resultType } = option;
    var searchObject = {};
    this.setState({ page: 0, loading: true, resultDateSearch: resultDateSearch, resultType: resultType });
    if(resultType){
  ...
  render() {
    ...
    let columns = [
      ...
      // { title: t("result.times"), field: "times", align: "left", width: "10 0" },
      {
        title: t("result.type"),
        field: "type",
        align: "left",
    ...
    return (
      <div className="m-sm-30">
        <div className="mb-sm-30">
          <Breadcrumb
            routeSegments={[{ name: t("Dashboard.testResult.byDay") }]}
          />
        </div>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} container spacing={2}>
            ...
            <Grid item md={12} sm={12} xs={12}>
              ...
              >
                <PatientResultHivFilter handleFilter={this.handleFilter} t={t} />
              </Collapse>
            </Grid>
          </Grid>
          <Grid item xs={12}>
