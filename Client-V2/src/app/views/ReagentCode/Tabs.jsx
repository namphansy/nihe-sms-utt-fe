...
import ReagentCodeInformation from "./ReagentCodeInformation";
import ReagentCodeFileAttachment from "./ReagentCodeFileAttachment";
...
export default function CreateStaff(props) {
    ...
    return (
        <div className={classes.root} value={value} index={0}>
         <ReagentCodeInformation t={t} useStyles={useStyles} item={props.item ? props.item : {}} />
            ...
            <TabPanel value={value} index={1} style={{ height: "427px" }} color="#ffffff">
                <ReagentCodeFileAttachment t={t} useStyles={useStyles} item={props.item ? props.item : {}} />
            </TabPanel> */}
        </div>
    );
}
