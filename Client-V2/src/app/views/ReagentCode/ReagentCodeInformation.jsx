...
import { checkCode, addNewReagent, updateReagent } from "./ReagentCodeService";
...
class NumberReagentInformation extends Component {
  state = {
    name: "",
    code: "",
    description: "",
        ...
        <Grid container spacing={2}>
          ...
          <Grid item lg={6} md={6} sm={12} xs={12}>
            <TextValidator
              ...
              // validators={["required","checkMaxLength"]}
              // errorMessages={t("general.errorMessages_required"),[t("MaxLength")]}
          ...
          <Grid item lg={6} md={6} sm={12} xs={12}>
            <TextValidator
              ...
              variant="outlined"
              size="small"
              // validators={["checkMaxLength","required"]}
              // errorMessages={[t("MaxLength",t("general.errorMessages_required"))]}
              validators={["required", "matchRegexp:^.{0,255}$"]}
              errorMessages={[
                t("general.errorMessages_required"),
                t("MaxLength"),
          ...
          <Grid item lg={6} md={6} sm={12} xs={12}>
            <MuiPickersUtilsProvider utils={DateFnsUtils}>
              <DateTimePicker
                ...
                id="mui-pickers-date"
                label={
                  <span className="font">{t("reagent.expirationDate")}</span>
                }
                // inputVariant="outlined"
                type="text"
                autoOk={false}
          ...
          {/* <Grid item lg={6} md={6} sm={12} xs={12}>
            <FormControl
              className="w-100"
              error={this.state.item?.hasTestType}
              variant="outlined"
              size="small"
            >
              <InputLabel htmlFor="testType">
                {
                  <span className="font">
                    <span style={{ color: "red" }}> * </span>
...
export default NumberReagentInformation;
