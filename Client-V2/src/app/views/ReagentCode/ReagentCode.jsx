...
import {
  ...
  searchReagent,
  getItemById,
} from "./ReagentCodeService";
import ReagentCodeEditorDialog from "./ReagentCodeEditorDialog";
...
class ReagentCode extends Component {
  state = {
    keyword: "",
    rowsPerPage: 10,
    page: 0,
  ...
  search() {
    ...
    this.setState({ page: 0 }, function () {
      ...
      searchReagent(searchObject, this.state.page, this.state.rowsPerPage).then(
        ({ data }) => {
          this.setState({
  ...
  render() {
    ...
    return (
      <div className="m-sm-30">
        <Helmet>
          <title>
            {t("reagentCode.title")} | {t("web_site")}
          </title>
        </Helmet>
...
export default connect(mapStateToProps, mapDispatch)(ReagentCode);
