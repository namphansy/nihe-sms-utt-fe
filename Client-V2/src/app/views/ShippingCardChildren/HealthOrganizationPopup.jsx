...
class HealthOrganizationPopup extends Component {
    ...
    render() {
        ...
        let columns = [
            ...
            { title: t('Tên đơn vị'), field: "name", align: "left", width: "150" },
            { title: t("Mã đơn vị"), field: "code", width: "150" },
        ...
        return (
            <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent} maxWidth={'lg'} fullWidth={true}>
                <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
                    <span className="mb-20 ">{t("Danh sách đơn vị")}</span>
                ...
                <DialogContent dividers>
                    <Grid container spacing={2}>
                        <Grid item lg={4} md={4} sm={6} xs={12}>
                            <FormControl fullWidth={true} variant="outlined" className="mb-32" size="small" >
