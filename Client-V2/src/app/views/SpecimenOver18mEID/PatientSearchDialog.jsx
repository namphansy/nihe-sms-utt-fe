...
class PatientSearchDialog extends React.Component {
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t('patient.name'), field: "fullName", align: "left", width: "150" },
      { title: t("patient.phone"), field: "phone", width: "150" },
      { title: t("patient.address"), field: "address", width: "150" },
    ]

    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent} maxWidth={'lg'} fullWidth={true}>
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <span className="mb-20">{t("patient.select")}</span>
