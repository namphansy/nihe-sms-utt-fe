...
export const exportExcelEID = (obj) =>{
  const url = API_PATH_EXPORT_EXCEL + "/exportResultByMonEID"; 
  return axios({
    url: url,
    method: "POST",
    responseType: "blob",
...
export const exportExcelVL = (obj) =>{
  const url = API_PATH_EXPORT_EXCEL + "/exportResultByMonVL"; 
  return axios({
    url: url,
    method: "POST",
    responseType: "blob",
