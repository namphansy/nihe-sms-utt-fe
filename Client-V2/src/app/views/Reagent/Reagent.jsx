    ...
    let columns = [
      ...
      },
      {
        ...
        render: (rowData) => (
          <Radio
            name="radSelected"
            value={rowData.healthDepartmentDirectory}
            checked={rowData.healthDepartmentDirectory}
          ></Radio>
        ),
      },
    ];
...
export default connect(mapStateToProps, mapDispatch)(Reagent);
