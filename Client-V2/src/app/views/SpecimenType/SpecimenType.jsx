...
import { deleteItem, searchByPage, getOne } from "./SpecimenTypeService"; //getAllEQAHealthOrgTypes,
// import HivPatientDialog from "./PatientDialog";
import SpecimenTypeDialog from "./SpecimenTypeDialog";
...
class SpecimenType extends Component {
  ...
  render() {
    ...
    let columns = [
      ...
      {
        title: t("specimenType.code"),
        field: "code",
        align: "left",
        width: "100",
      },
      {
        title: t("specimenType.name"),
        field: "name",
        align: "left",
        width: "100",
      },
      {
        title: t("specimenType.description"),
        field: "description",
        align: "left",
        width: "100",
      },
...
export default connect(mapStateToProps, mapDispatch)(SpecimenType);
